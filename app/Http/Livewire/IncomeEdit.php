...
class IncomeEdit extends Component
{
    ...
    public function render()
    {
        ...
        $firstMainMember = $application->householdMembers->first();
        $data['incomePredictable'] = $firstMainMember->income_predictable ?? 0; // Exemplo
        $data['incomePredictedAmount'] = $firstMainMember->income_predicted_amount ?? null;
        ...
        return view('livewire.income-edit', $data);
    }
}
