                ...
                <div class="main-container container-fluid">
                        ...
                        <div class="hor-logo">
                            <a class="main-logo" href="{{url('index')}}">
                                <img src="{{asset('build/assets/img/brand/logo-white.png')}}" class="header-brand-img desktop-logo"
                                    alt="logo">
                                <img src="{{asset('build/assets/img/brand/logo.png')}}" class="header-brand-img desktop-logo-dark"
                                    alt="logo">
                            </a>
                        </div>
                    </div>
                    <div class="main-header-center">
                        <div class="responsive-logo">
                            <a href="{{url('index')}}"><img src="{{asset('build/assets/img/brand/logo.png')}}" class="mobile-logo" alt="logo"></a>
                            <a href="{{url('index')}}"><img src="{{asset('build/assets/img/brand/logo-white.png')}}" class="mobile-logo-dark" alt="logo"></a>
                        </div>
                    </div>
