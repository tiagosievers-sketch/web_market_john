                                    ...
                                    <div class="input-group-text">
                                        <label class="ckbox wd-16 mg-b-0">
                                            <input class="mg-0 household-member-checkbox" type="checkbox"
                                                ...
                                                data-question="firstQuestion" data-member-id="{{ $member['id'] }}">
                                            <span></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="input-group-text">
                                        <label class="ckbox wd-16 mg-b-0">
                                            <input class="mg-0 household-member-checkbox" type="checkbox"
                                                ...
                                                data-question="secondQuestion" data-member-id="{{ $member['id'] }}">
                                            <span></span>
                                        </label>
                                    </div>
                                    <div class="form-control">{{ $member['firstname'] }}</div>
                            ...
                            @foreach ($householdMembers as $member)
                                <div class="input-group mb-2">
                                    <div class="input-group-text">
                                        <label class="ckbox wd-16 mg-b-0">
                                            <input class="mg-0 household-member-checkbox" type="checkbox"
                                                name="fourthQuestion[{{ $member['id'] }}]" value="{{ $member['id'] }}"
                                                data-member-id="{{ $member['id'] }}">
                                            <span></span>
                                        </label>
                                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('/js/additionalQuestion/additionalQuestion.js') }}"></script>
            ...
            $('.household-member-checkbox').each(function() {
                ...
                if (
                    ...
                    householdMembersData[memberId] = householdMembersData[memberId] || {
                        ...
                        chip_coverage_ends_between: chipCoverageEndsBetween,
                        change_income_or_household_size: changeIncomeOrHouseholdSize,
                        ...
                        date_dented_coverage: dateDentedCoverage || null,
                        coverage_between: coverageBetween,
                        apply_marketplace_qualifying_life_event: applyMarketplaceQualifyingLifeEvent
                    };
                }
            });
