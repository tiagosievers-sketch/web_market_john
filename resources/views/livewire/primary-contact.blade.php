...
@section('content')
    ...
    <form id="form_application" method="POST" action="{{ route('application.store') }}" onsubmit="showLoading();">
        @csrf
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <select class="form-select" id="mail_county" name="mail_county">
                                                    <option value="" selected>@lang('labels.campoSelecao')</option>
                                                    <!-- <option value="testecounty">testecounty2</option> -->
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        placeholder="@lang('labels.enderecoEmail')">
                                </div>
                            </div>
                        </div>
                    </div>
