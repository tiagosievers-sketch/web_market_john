    ...
    <div id="tabIncome" class="tabcontent" style="display: block;">
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row row-sm">
                        <label class="col-form-label">@lang('labels.incomeQuestionDeductionsQuestion', [
                            //aqui vai o valor calculado já
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row row-sm">
                                    <label class="col-form-label">@lang('labels.questionIncomeModal', ['year' => date('Y'), 'name' => $firstMainMember->firstname . ' ' . $firstMainMember->lastname . ''])</label>
                                    <div class="col-lg-6 mb-3">
                                        <div class="input-group">
                                            <div class="input-group-text">
                                                <label class="rdiobox wd-16 mg-b-0">
                            ...
                            <div class="row mb-3 col-lg-12 ms-1">
                                <div class="col-lg-4 mt-1"id="amountModal3" style="display: none;">
                                    <div class="input-group">
                                        <div class="input-group-text">@lang('labels.amountIncomeSymbol'):</div>
                                        <input type="text" class="form-control" name="amountModal3Income"
                                            id="amountModal3Income" placeholder="@lang('labels.amountIncome')">
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#saveDeductionBtnPredict').on('click', function(e) {
                ...
                const income_confirmed = $('input[name="checkIncomeing"]:checked').val() === "1" ? 1 :
                    0;
                                ...
                                itemHTML = `
                                    <div class="income-item border rounded p-3 mb-2">
                                        <div>
                                            ...
                                            ${item.unemployment_date ? `<div><strong>@lang('labels.dataDesemprego'):</strong> ${new Date(item.unemployment_date).toLocaleDateString('en-US')}</div>` : ''}
                                        </div>
